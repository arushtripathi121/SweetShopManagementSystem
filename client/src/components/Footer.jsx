...
const Footer = () => {
    return (
        <div className="bg-black text-gray-300 py-10 px-6 md:px-16 font-poppins">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
                ...
                <div>
                    <img
                        src={logo}
                        alt="SweetShop Logo"
                        className="w-32 mb-3 select-none"
                    />

                    <p className="mt-3 text-sm leading-relaxed">
                        Freshly prepared Indian sweets made with love.
                        Delicious, hygienic, and delivered straight to your door.
                    </p>
